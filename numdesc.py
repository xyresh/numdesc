#program to prove that four is the only number where its name "FOUR"
#actually describes it's name
#hypothesis by Kostas max and the code written by stackoverflow and Marios Par
#proven correct byt the following simple python program
